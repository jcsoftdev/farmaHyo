...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            buscarmedicamento(){
                ...
                axios.get(url).then(function (response) {
                    ...
                    if (me.arraymedicamento.length>0){
                        ...
                        me.precio=me.arraymedicamento[0]['precio_ingreso'];
            ...
            //             me.errorMostrarMsjIngreso.push(art);
            //         }
            //     });

            //     if (me.proveedor=="") me.errorMostrarMsjIngreso.push("Seleccione un Proveedor");
            //     if (me.tipo_comprobante==0) me.errorMostrarMsjIngreso.push("Seleccione el comprobante");
            //     if (!me.num_comprobante) me.errorMostrarMsjIngreso.push("Ingrese el número de comprobante");
            //     if (!me.impuesto) me.errorMostrarMsjIngreso.push("Ingrese el impuesto de compra");
            //     if (me.arrayDetalle.length<=0) me.errorMostrarMsjIngreso.push("Ingrese detalles");

            //     if (me.errorMostrarMsjIngreso.length) me.errorIngreso = 1;

            //     return me.errorIngreso;
            // },
            validarIngreso(){
                this.errorIngreso=0;
