                                ...
                                <div class="form-group row container-fluid">
                                    <div class="input-group">
                                        ...
                                        <v-layout wrap align-center justify-space-around>
                                            ...
                                            <v-flex xs12 sm1 >
                                                <v-btn @click="listarPersona(1,buscar,criterio)" depressed large color="primary"><i class="fa fa-search ml-1"></i></v-btn>
                                            </v-flex>
                                        </v-layout>
                                        </v-container>
                                    </div>
                        ...
                        if (result.value) {
                            switch (accion) {
                                ...
                                case 'desactivar':
                                    ...
                                    .catch(function (error) {
                                        console.log(error);
                                        me.alerta('error','Falla al desactivar el cliente');
                                    });
                                    break;
